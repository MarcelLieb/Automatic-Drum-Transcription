...
final_experiment_params = {
    ...
    'Attention faster': {'activation': 'SiLU',
      'batch_size': 6,
      'beats': False,
    ...
    'Attention no conv': {'activation': 'SELU',
      'batch_size': 7,
      'beats': False,
